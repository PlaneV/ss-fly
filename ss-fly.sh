#! /bin/bash
# Copyright (c) 2018 flyzy小站  update by 七彩blog
...
install() {
        ...
        then 
                ...
                echo -e "[${red}错误${plain}] ss服务器安装失败，请联系七彩blog（https://www.7colorblog.com）"
                cleanup
                exit 1
        fi      
        ...
        echo -e "欢迎访问七彩blog   ：\033[41;37m https://www.7colorblog.com \033[0m"                   
}
...
case $1 in
	-h|h|help )
		...
		;;
	-v|v|version )
		echo 'ss-fly Version 1.0, 2018-01-20, Copyright (c) 2018 七彩blog'
		exit 0;
		;;
esac
